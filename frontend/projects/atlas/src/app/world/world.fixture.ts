...
export const FIXTURE_WORLD: WorldData = {
  ...
  nodes: [
    ...
    { id: 'n-fig', cell: { col: 2, row: 5 }, kind: 'species', kindLabel: 'Species', name: 'Fiddle-leaf Fig', recap: '12 plants · 1 overdue', recapNote: 'Ficus lyrata', detail: ['Ficus lyrata — the fiddle-leaf fig.', '12 of your plants are this species.', '1 is overdue for water.'] },
    ...
    { id: 'n-ident', cell: { col: 4, row: 10 }, kind: 'platform', kindLabel: 'Identification', name: 'Identification', recap: 'Last scan failed', state: 'failed', failure: { fact: 'The last scan could not be identified.', time: '2 minutes ago', dataNote: 'Your photo is safe — nothing was lost.', waysForward: ['Retry', 'Pick manually'] } },
    ...
    { id: 'n-reminders', cell: { col: 6, row: 4 }, kind: 'journal', kindLabel: 'Reminders', name: 'Reminders', recap: 'Nothing due', state: 'empty' },
    ...
    { id: 'n-unknown', cell: { col: 8, row: 3 }, kind: 'region', kindLabel: 'Region', name: 'Unloaded region', recap: 'Not fetched yet', unknown: true, state: 'unknown' },
  ],
  edges: [
