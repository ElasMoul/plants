...
@NgModule({
  ...
  imports: [LanguageSwitchComponent, PluralSuffixPipe, TranslatePipe,CommonModule, RouterModule, FormsModule, ReactiveFormsModule, ...MATERIAL_MODULES],
  exports: [LanguageSwitchComponent, PluralSuffixPipe, TranslatePipe,
    CommonModule,
    RouterModule,
    FormsModule,
    ReactiveFormsModule,
