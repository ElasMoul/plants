...
| I18N explicit sections | Complete on `codex/explicit-section-translations` (2026-09-24): static-only UI switching, new generation uses account language, manual saved EN/FR/AR section variants with contextual translate icons beside read-aloud (no dropdowns), no global banner/read-triggered translation, section-matched speech; migration 039; owner testing pending |
